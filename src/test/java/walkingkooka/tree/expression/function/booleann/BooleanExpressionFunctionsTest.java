...
public final class BooleanExpressionFunctionsTest implements PublicStaticHelperTesting<BooleanExpressionFunctions> {
    ...
    public void testExpressionFunctionProvider() {
        this.checkEquals(
                ...
                BooleanExpressionFunctions.expressionFunctionProvider(CaseSensitivity.SENSITIVE)
    ...
    @Override
    public Class<BooleanExpressionFunctions> type() {
        return BooleanExpressionFunctions.class;
    }
